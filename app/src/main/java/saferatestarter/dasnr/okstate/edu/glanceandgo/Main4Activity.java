...
public class Main4Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final AlertDialog alertDialogNo = new AlertDialog.Builder(Main4Activity.this).create();
        ...
        final AlertDialog alertDialogYes = new AlertDialog.Builder(Main4Activity.this).create();
        ...
        final AlertDialog alertDialogMore = new AlertDialog.Builder(Main4Activity.this).create();
        ...
        finalsubmit.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                switch (tv){
                    case 1:
                if (rbChecked >= 5 || cbChecked <= 6) {
                    // test.setText("Activity 3");
                    //test.setText("Don't treat");
                    alertDialogNo.show();
                } else if (cbChecked >= 7 && cbChecked <= 9) {
                    //keep sampling
                ...
                break;
                    case 3:
                        if (rbChecked >= 5 || cbChecked <= 13) {
                           alertDialogNo.show();
                        } else if (cbChecked >= 14 && cbChecked <= 21) {
                           alertDialogMore.show();
                            new Handler().postDelayed(new Runnable() {
                                @Override
                                public void run() {
                        ...
                        break;
                    case 5:
                        if (rbChecked >= 5 || cbChecked <= 16) {
                            alertDialogNo.show();
                        } else if (cbChecked >= 17 && cbChecked <= 29) {
                            alertDialogMore.show();
                            new Handler().postDelayed(new Runnable() {
                                @Override
                                public void run() {
                        ...
                        } else if (cbChecked >= 30) {
                            alertDialogYes.show();
                        }
                        break;
                    case 7:
                        if (rbChecked >= 5 || cbChecked <= 19) {
                            alertDialogNo.show();
                        } else if (cbChecked >= 20 && cbChecked <= 34) {
                            alertDialogMore.show();
                            new Handler().postDelayed(new Runnable() {
                                @Override
                                public void run() {
                        ...
                        } else if (cbChecked >= 35) {
                            alertDialogYes.show();
                        }
                        break;
                    case 9:
                        if (rbChecked >= 5 || cbChecked <= 22) {
                            alertDialogNo.show();
                        } else if (cbChecked >= 23 && cbChecked <= 36) {
                            alertDialogMore.show();
                            new Handler().postDelayed(new Runnable() {
                                @Override
                                public void run() {
