...
public class Main6Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final AlertDialog alertDialogNo = new AlertDialog.Builder(Main6Activity.this).create();
        ...
        final AlertDialog alertDialogYes = new AlertDialog.Builder(Main6Activity.this).create();
        ...
        final AlertDialog alertDialogMore = new AlertDialog.Builder(Main6Activity.this).create();
            ...
            public void onClick(View v) {
                ...
                if (rbChecked >= 7 || cbChecked <= 11) {
                    ...
                    new Handler().postDelayed(new Runnable() {
                        @Override
                        public void run() {
                            Intent myIntent = new Intent(Main6Activity.this, Main4Activity.class);
                ...
                break;
                    case 3:
                        if (rbChecked >= 7 || cbChecked <= 25) {
                            alertDialogNo.show();
                        } else if (cbChecked >= 26 && cbChecked <= 33) {
                            alertDialogMore.show();
                            new Handler().postDelayed(new Runnable() {
                                @Override
                                public void run() {
                        ...
                        } else if (cbChecked >= 34) {
                            alertDialogYes.show();
                        }
                        break;
                    case 5:
                        if (rbChecked >= 7 || cbChecked <= 32) {
                            alertDialogNo.show();
                        } else if (cbChecked >= 33 && cbChecked <= 44) {
                            alertDialogMore.show();
                            new Handler().postDelayed(new Runnable() {
                                @Override
                                public void run() {
                        ...
                        } else if (cbChecked >= 45) {
                            alertDialogYes.show();
                        }
                        break;
                    case 7:
                        if (rbChecked >= 7 || cbChecked <= 37) {
                            alertDialogNo.show();
                        } else if (cbChecked >= 38 && cbChecked <= 53) {
                            alertDialogMore.show();
                            new Handler().postDelayed(new Runnable() {
                                @Override
                                public void run() {
                        ...
                        } else if (cbChecked >= 54) {
                            alertDialogYes.show();
                        }
                        break;
                    case 9:
                        if (rbChecked >= 7 || cbChecked <= 42) {
                            alertDialogNo.show();
                        } else if (cbChecked >= 43 && cbChecked <= 57) {
                            alertDialogMore.show();
                            new Handler().postDelayed(new Runnable() {
                                @Override
                                public void run() {
