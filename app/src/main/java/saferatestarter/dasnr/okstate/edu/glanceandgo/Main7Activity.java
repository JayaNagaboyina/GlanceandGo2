...
public class Main7Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final AlertDialog alertDialogNo = new AlertDialog.Builder(Main7Activity.this).create();
        ...
        final AlertDialog alertDialogYes = new AlertDialog.Builder(Main7Activity.this).create();
        ...
        final AlertDialog alertDialogMore = new AlertDialog.Builder(Main7Activity.this).create();
        alertDialogMore.setTitle("Alert");
        alertDialogMore.setMessage("Stop sampling, resample in 2-6 days (You will be redirected to sample page in 4 seconds)");
        ...
        finalsubmit.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                switch (tv){
                    case 1:
                if (rbChecked >= 7 || cbChecked <= 11) {
                    alertDialogNo.show();
                } else if (cbChecked >= 12 && cbChecked <= 14) {
                    alertDialogMore.show();
                } else if (cbChecked >= 13) {
                    alertDialogYes.show();
                }
                break;
                    case 3:
                        if (rbChecked >= 8 || cbChecked <= 31) {
                            alertDialogNo.show();
                        } else if (cbChecked >= 32 && cbChecked <= 39) {
                            alertDialogMore.show();
                        } else if (cbChecked >= 40) {
                            alertDialogYes.show();
                        }
                        break;
                    case 5:
                        if (rbChecked >= 8 || cbChecked <= 40) {
                            alertDialogNo.show();
                        } else if (cbChecked >= 41 && cbChecked <= 52) {
                            alertDialogMore.show();
                        } else if (cbChecked >= 53) {
                            alertDialogYes.show();
                        }
                        break;
                    case 7:
                        if (rbChecked >= 8 || cbChecked <= 46) {
                            alertDialogNo.show();
                        } else if (cbChecked >= 47 && cbChecked <= 62) {
                            alertDialogMore.show();
                        } else if (cbChecked >= 63) {
                            alertDialogYes.show();
                        }
                        break;
                    case 9:
                        if (rbChecked >= 8 || cbChecked <= 53) {
                            alertDialogNo.show();
                        } else if (cbChecked >= 54 && cbChecked <= 67) {
                            alertDialogMore.show();
                        } else if (cbChecked >= 68) {
                            alertDialogYes.show();
                        }
                        break;
            }
