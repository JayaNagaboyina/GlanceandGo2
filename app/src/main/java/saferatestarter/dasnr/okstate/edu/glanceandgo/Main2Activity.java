...
public class Main2Activity extends AppCompatActivity {
    ...
    static int rbChecked = 0;
    static int cbChecked = 0;
    Button finalsubmit;
    Button reset;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //getting value of the threshold
        Bundle thresh = getIntent().getExtras();
        tv = thresh.getInt("tv");

        //getting value of the season
        Intent val = getIntent();
        sv = val.getExtras().getString("sv");
        ...
        final AlertDialog alertDialogNo = new AlertDialog.Builder(Main2Activity.this).create();
        ...
        final AlertDialog alertDialogYes = new AlertDialog.Builder(Main2Activity.this).create();
        ...
        final AlertDialog alertDialogMore = new AlertDialog.Builder(Main2Activity.this).create();
        ...
        reset.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                //using OR for mummies and tillers
                //test of switch statement
                if (sv.equals("Fall")) {
                    switch (tv) {
                        case 1:
                            if (rbChecked >= 4 || cbChecked <= 0) {
                               // test.setText("Don't treat");
                                alertDialogNo.show();

                            } else if (cbChecked >= 1 && cbChecked <= 4) {
                        ...
                        case 3:
                            if (rbChecked >= 4 || cbChecked <= 1) {
                                alertDialogNo.show();
                            } else if (cbChecked >= 2 && cbChecked <= 9) {
                                alertDialogMore.show();
                                new Handler().postDelayed(new Runnable() {
                                    @Override
                                    public void run() {
                        ...
                        case 5:
                            if (rbChecked >= 4 || cbChecked <= 1) {
                                alertDialogNo.show();
                            } else if (cbChecked >= 2 && cbChecked <= 13) {
                                alertDialogMore.show();
                                new Handler().postDelayed(new Runnable() {
                                    @Override
                                    public void run() {
                        ...
                        case 7:
                            if (rbChecked >= 4 || cbChecked <= 1) {
                                alertDialogNo.show();
                            } else if (cbChecked >= 2 && cbChecked <= 15) {
                                alertDialogMore.show();
                                new Handler().postDelayed(new Runnable() {
                                    @Override
                                    public void run() {
                            ...
                            break;
                        case 9:
                            if (rbChecked >= 4 || cbChecked <= 2) {
                                alertDialogNo.show();
                            } else if (cbChecked >= 3 && cbChecked <= 15) {
                                alertDialogMore.show();
                                new Handler().postDelayed(new Runnable() {
                                    @Override
                                    public void run() {
                ...
                //checking for spring season
                    ...
                    switch (tv) {
                      ...
                      //do the same changes in other activities for spring
                     }
            }
