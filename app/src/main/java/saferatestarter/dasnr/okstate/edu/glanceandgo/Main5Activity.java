...
public class Main5Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final AlertDialog alertDialogNo = new AlertDialog.Builder(Main5Activity.this).create();
        ...
        final AlertDialog alertDialogYes = new AlertDialog.Builder(Main5Activity.this).create();
        ...
        final AlertDialog alertDialogMore = new AlertDialog.Builder(Main5Activity.this).create();
        ...
        finalsubmit.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                switch (tv){
                    case 1:
                if (rbChecked >= 6 || cbChecked <= 9) {
                    // test.setText("Activity 3");
                    //test.setText("Don't treat");
                    alertDialogNo.show();
                } else if (cbChecked >= 10 && cbChecked <= 12) {
                    //keep sampling
                ...
                break;
                    case 3:
                        if (rbChecked >= 6 || cbChecked <= 19) {
                            alertDialogNo.show();
                        } else if (cbChecked >= 20 && cbChecked <= 27) {
                            alertDialogMore.show();
                            new Handler().postDelayed(new Runnable() {
                                @Override
                                public void run() {
                        ...
                        } else if (cbChecked >= 28) {
                            alertDialogYes.show();
                        }
                        break;
                    case 5:
                        if (rbChecked >= 6 || cbChecked <= 24) {
                            alertDialogNo.show();
                        } else if (cbChecked >= 25 && cbChecked <= 36) {
                            alertDialogMore.show();
                            new Handler().postDelayed(new Runnable() {
                                @Override
                                public void run() {
                        ...
                        } else if (cbChecked >= 37) {
                            alertDialogYes.show();
                        }
                        break;
                    case 7:
                        if (rbChecked >= 6 || cbChecked <= 28) {
                            alertDialogNo.show();
                        } else if (cbChecked >= 29 && cbChecked <= 44) {
                            alertDialogMore.show();
                            new Handler().postDelayed(new Runnable() {
                                @Override
                                public void run() {
                        ...
                        break;
                    case 9:
                        if (rbChecked >= 6 || cbChecked <= 32) {
                            alertDialogNo.show();
                        } else if (cbChecked >= 33 && cbChecked <= 47) {
                            alertDialogMore.show();
                            new Handler().postDelayed(new Runnable() {
                                @Override
                                public void run() {
